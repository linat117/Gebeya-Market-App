  ...
  return (
    <div className="bg-[#FFFFFF] w-screen h-[4.1rem] space-x-[2.75rem]">
      <div className="flex bg-[#FFFFFF] w-[1352px] h-[46.5px] ml-[5rem] mr-[5rem] mt-[1.5rem] mb-[1.22rem]">
        ...
        <div className="flex mt-[0.7rem] ml-[4.75rem]">
          <ul className={`flex space-x-[24px] ${isMenuOpen ? "flex-col" : ""}`}>
            <li className="flex">
              <button className="flex w-[165px] h-[24px]" onClick={toggleDropdown}>
                ...
                <img src={isOpen ? "/icons/up.png" : "/icons/down.png"} className="w-[16px] h-[16px] mt-[0.25rem]" />
              </button>
              {isOpen && (
                <div id="dropdown-menu" className="absolute bg-white border border-[#C1C1C1] w-[194px] h-[132px] mt-[2.73rem] ml-[0.62rem]">
                  <li className="h-[44px] py-[10px]"><a href="/Home" className="ml-[4rem] mt-[1.6rem] font-poppins text-[16px] font-medium text-[#000000]">Register</a></li>
            ...
            <li>
              <button onClick={toggleMoreDropdown} className="flex w-[60px] h-[24px] space-x-[4px]">
              ...
              {isMoreOpen && (
                <div className="absolute bg-white border border-[#C1C1C1] w-[194px] h-[280px] ml-[-3.07rem] mt-[1.3rem]">
        ...
        <div className="flex ml-[2.75rem] mt-[0.2rem] w-[275px] h-[40px] border border-[#C6C6C6] rounded-[16px]">
          <div className="flex w-[197px] h-[40px] px-[8px] py-[8px]">
            <img src="/icons/search.png" className="w-[16px] h-[16px] text-[#1E1E1E] ml-[0.5rem] mt-[4px]" />
            <input type="text" placeholder="Search" className="w-[57px] h-[24px] font-poppins text-[16px] text-[#1E1E1E] ml-[0.5rem]" />
          </div>
          <div className="rounded-r-[16px] w-[78px] h-[40px] space-x-[10px] ml-[1rem] bg-[#882BEC]">
            <img src="/icons/search.png" className="ml-[23px] mt-[8px] w-[20.28px] h-[20.28px] invert" />
          </div>
        </div>
      ...
      <div className="lg:hidden flex justify-between items-center ">
        ...
        {isMenuOpen && (
          <div className="absolute top-0 right-0 bg-white w-[200px] p-4 shadow-lg">
            <ul>
              <li><a href="/" className="font-poppins text-[16px] text-[#1E1E1E]">Home</a></li>
              <li><a href="#" className="font-poppins text-[16px] text-[#1E1E1E]">Men</a></li>
              <li><a href="#" className="font-poppins text-[16px] text-[#1E1E1E]">Women</a></li>
              <li><a href="#" className="font-poppins text-[16px] text-[#1E1E1E]">Kids</a></li>
              <li><a href="#" className="font-poppins text-[16px] text-[#1E1E1E]">Accessories</a></li>
              <li><a href="/cart" className="font-poppins text-[16px] text-[#1E1E1E]">Cart</a></li>
            </ul>
          </div>
        )}
      </div>
